  ...
  const feeSummary = useMemo(() => {
    ...
    return {
      netFee: {
        ...
        breakdown: {
          networkFee: `${bridgeQuote.relayerGasFee.amountFormatted} ${bridgeQuote.tokenSymbol}`,
          relayerFee: `${bridgeQuote.relayerCapitalFee.amountFormatted} ${bridgeQuote.tokenSymbol}`
        }
      },
      eta: {
        label: "ETA",
